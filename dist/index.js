...
const { context } = __nccwpck_require__(103);
...
const github = __nccwpck_require__(103);
const { WebClient } = __nccwpck_require__(296);
const { buildSlackAttachments, formatChannelName } = __nccwpck_require__(178);
